...
![skills](https://skillicons.dev/icons?i=cs,dotnet,py,html,css,js,nodejs,md,docker,linux,nginx,mysql,redis,sqlite,git,github,githubactions,gitlab,visualstudio,vscode,jenkins,powershell,stackoverflow,vue,bootstrap)
